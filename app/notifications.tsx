  ...
  return (
    <View style={styles.screen}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.sect}>Push Notifications</Text>
        <View style={styles.list}>
          <ToggleRow label="Allow Push Notifications" initial={true} />
        </View>

        <Text style={styles.sect}>Notify me about</Text>
        <View style={styles.list}>
          <ToggleRow label="Event Reminders" sub="Upcoming events and tasks" initial={true} />
          <ToggleRow label="Booking Updates" sub="Booking confirmations and changes" initial={true} />
          <ToggleRow label="Tips & Recommendations" sub="Helpful suggestions and ideas" initial={true} />
          <ToggleRow label="Marketing & Offers" sub="News, offers and updates" initial={false} />
        </View>
      </ScrollView>
    </View>
  );
