...
const RANGES = ['Under 25,000', '25,000 – 50,000', '50,000 – 100,000', 'Above 100,000', 'Not sure yet'];

export default function CreateEventBudgetScreen() {
  const [selected, setSelected] = useState('25,000 – 50,000');
  ...
  return (
    <View style={styles.screen}>
      ...
      <Text style={styles.title}>What is your estimated budget?</Text>
      <Text style={styles.sub}>You can change this later.</Text>
      <Text style={styles.label}>BUDGET RANGE (EGP)</Text>

      <View style={styles.list}>
        {RANGES.map((r) => (
          <TouchableOpacity key={r} style={styles.row} onPress={() => setSelected(r)}>
            <Text style={styles.rowLabel}>{r}</Text>
            <View style={[styles.radioCircle, selected === r && styles.radioCircleOn]}>
      ...
      <TouchableOpacity style={styles.primaryBtn} onPress={() => router.push('/create-event-guests')}>
